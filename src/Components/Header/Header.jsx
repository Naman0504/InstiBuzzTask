    ...
    <>
      <div className="w-full flex flex-col px-2 py-4">
        <div className="flex justify-around gap-6 md:p-2 md:shadow-slate-50  ">
          <div className="border border-black sm:w-1/5 sm:justify-center flex justify-left  md:justify-center w-full md:w-1/4  md:p-3 ">
            <img
          ...
          <div className="hidden sm:flex border border-black md:flex py-auto justify-center w-full ">
